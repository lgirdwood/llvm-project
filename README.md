...
- **SOF Repository**:
  Pull the [upstream-rebase](https://github.com/lgirdwood/sof/tree/upstream-rebase) branch from the [SOF fork](https://github.com/lgirdwood/sof.git):
  ```bash
  cd sof
  git remote add lgirdwood https://github.com/lgirdwood/sof.git
  git fetch lgirdwood upstream-rebase
  git checkout -b my-working-branch # or checkout your current working branch
  git pull lgirdwood upstream-rebase
  cd ..
  ```

- **Zephyr Repository**:
  Pull the [zephyr-upstream-rebase](https://github.com/lgirdwood/zephyr/tree/zephyr-upstream-rebase) branch from the [Zephyr fork](https://github.com/lgirdwood/zephyr.git):
  ```bash
  cd zephyr
  git remote add lgirdwood https://github.com/lgirdwood/zephyr.git
  git fetch lgirdwood zephyr-upstream-rebase
  git checkout -b my-working-branch # or checkout your current working branch
  git pull lgirdwood zephyr-upstream-rebase
  cd ..
  ```
