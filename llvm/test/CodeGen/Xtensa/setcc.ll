...
; CHECK-NEXT:    s32i a8, a1, 12 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB0_2:
; CHECK-NEXT:    l32i a2, a1, 12 # 4-byte Folded Reload
; CHECK-NEXT:    addi a8, a1, 16
; CHECK-NEXT:    or a1, a8, a8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    s32i a9, a1, 8 # 4-byte Folded Spill
...
; CHECK-NEXT:    s32i a8, a1, 12 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB10_2:
; CHECK-NEXT:    l32i a3, a1, 8 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a2, a1, 12 # 4-byte Folded Reload
; CHECK-NEXT:    addi a8, a1, 16
; CHECK-NEXT:    or a1, a8, a8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    or a1, a8, a8
; CHECK-NEXT:    s32i a5, a1, 20 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a4, a1, 24 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a3, a1, 28 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a2, a1, 32 # 4-byte Folded Spill
; CHECK-NEXT:    movi a8, 0
; CHECK-NEXT:    s32i a8, a1, 36 # 4-byte Folded Spill
; CHECK-NEXT:    movi a8, 1
; CHECK-NEXT:    s32i a8, a1, 40 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a8, a1, 44 # 4-byte Folded Spill
; CHECK-NEXT:    blt a3, a5, .LBB11_2
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    l32i a8, a1, 36 # 4-byte Folded Reload
; CHECK-NEXT:    s32i a8, a1, 44 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB11_2:
; CHECK-NEXT:    l32i a8, a1, 32 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a9, a1, 24 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a10, a1, 40 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a11, a1, 44 # 4-byte Folded Reload
; CHECK-NEXT:    s32i a11, a1, 12 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a10, a1, 16 # 4-byte Folded Spill
; CHECK-NEXT:    bltu a8, a9, .LBB11_4
; CHECK-NEXT:  # %bb.3:
; CHECK-NEXT:    l32i a8, a1, 36 # 4-byte Folded Reload
; CHECK-NEXT:    s32i a8, a1, 16 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB11_4:
; CHECK-NEXT:    l32i a8, a1, 28 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a9, a1, 20 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a10, a1, 16 # 4-byte Folded Reload
...
; CHECK-NEXT:    s32i a8, a1, 8 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB11_6:
; CHECK-NEXT:    l32i a3, a1, 36 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a2, a1, 8 # 4-byte Folded Reload
; CHECK-NEXT:    addi a8, a1, 48
; CHECK-NEXT:    or a1, a8, a8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    l32i a9, a1, 32 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a10, a1, 40 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a11, a1, 44 # 4-byte Folded Reload
; CHECK-NEXT:    s32i a11, a1, 12 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a10, a1, 16 # 4-byte Folded Spill
