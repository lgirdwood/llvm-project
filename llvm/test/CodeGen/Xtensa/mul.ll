...
; XTENSA-NEXT:    or a1, a8, a8
; XTENSA-NEXT:    s32i a0, a1, 76 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a12, a1, 72 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a13, a1, 68 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a14, a1, 64 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a15, a1, 60 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a5, a1, 36 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a4, a1, 32 # 4-byte Folded Spill
; XTENSA-NEXT:    or a13, a3, a3
; XTENSA-NEXT:    l32r a15, .LCPI30_0
; XTENSA-NEXT:    movi a12, 0
; XTENSA-NEXT:    l32r a8, .LCPI30_1
; XTENSA-NEXT:    s32i a2, a1, 52 # 4-byte Folded Spill
; XTENSA-NEXT:    or a3, a12, a12
; XTENSA-NEXT:    or a4, a15, a15
; XTENSA-NEXT:    or a5, a12, a12
; XTENSA-NEXT:    callx0 a8
; XTENSA-NEXT:    s32i a2, a1, 44 # 4-byte Folded Spill
...
; XTENSA-NEXT:    s32i a8, a1, 48 # 4-byte Folded Spill
; XTENSA-NEXT:    movi a14, -1
; XTENSA-NEXT:    l32r a8, .LCPI30_3
; XTENSA-NEXT:    l32i a2, a1, 52 # 4-byte Folded Reload
; XTENSA-NEXT:    or a3, a12, a12
...
; XTENSA-NEXT:    or a8, a15, a15
; XTENSA-NEXT:    s32i a9, a1, 40 # 4-byte Folded Spill
; XTENSA-NEXT:    bltu a9, a2, .LBB30_4
; XTENSA-NEXT:  # %bb.3:
; XTENSA-NEXT:    or a8, a12, a12
; XTENSA-NEXT:  .LBB30_4:
; XTENSA-NEXT:    add a8, a3, a8
; XTENSA-NEXT:    l32i a9, a1, 48 # 4-byte Folded Reload
; XTENSA-NEXT:    add a13, a9, a8
; XTENSA-NEXT:    l32r a8, .LCPI30_4
; XTENSA-NEXT:    l32i a2, a1, 56 # 4-byte Folded Reload
; XTENSA-NEXT:    or a3, a12, a12
; XTENSA-NEXT:    or a4, a14, a14
; XTENSA-NEXT:    or a5, a12, a12
; XTENSA-NEXT:    callx0 a8
...
; XTENSA-NEXT:    l32i a3, a1, 36 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a4, a1, 28 # 4-byte Folded Reload
; XTENSA-NEXT:    or a5, a14, a14
; XTENSA-NEXT:    callx0 a8
; XTENSA-NEXT:    s32i a2, a1, 32 # 4-byte Folded Spill
; XTENSA-NEXT:    s32i a3, a1, 36 # 4-byte Folded Spill
; XTENSA-NEXT:    l32r a8, .LCPI30_6
; XTENSA-NEXT:    l32i a2, a1, 52 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a3, a1, 56 # 4-byte Folded Reload
; XTENSA-NEXT:    or a4, a14, a14
; XTENSA-NEXT:    or a5, a14, a14
; XTENSA-NEXT:    callx0 a8
; XTENSA-NEXT:    l32i a8, a1, 32 # 4-byte Folded Reload
...
; XTENSA-NEXT:    l32i a11, a1, 16 # 4-byte Folded Reload
; XTENSA-NEXT:    bltu a13, a11, .LBB30_8
; XTENSA-NEXT:  # %bb.7:
; XTENSA-NEXT:    or a10, a12, a12
; XTENSA-NEXT:  .LBB30_8:
; XTENSA-NEXT:    or a11, a15, a15
; XTENSA-NEXT:    l32i a7, a1, 48 # 4-byte Folded Reload
...
; XTENSA-NEXT:    l32i a7, a1, 20 # 4-byte Folded Reload
...
; XTENSA-NEXT:    l32i a9, a1, 36 # 4-byte Folded Reload
; XTENSA-NEXT:    add a9, a3, a9
; XTENSA-NEXT:    add a9, a9, a15
; XTENSA-NEXT:    add a9, a10, a9
; XTENSA-NEXT:    add a5, a9, a8
; XTENSA-NEXT:    l32i a2, a1, 44 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a3, a1, 40 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a15, a1, 60 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a14, a1, 64 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a13, a1, 68 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a12, a1, 72 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a0, a1, 76 # 4-byte Folded Reload
; XTENSA-NEXT:    addi a8, a1, 80
; XTENSA-NEXT:    or a1, a8, a8
; XTENSA-NEXT:    ret
;
...
; XTENSA-MUL-NEXT:    or a1, a8, a8
; XTENSA-MUL-NEXT:    s32i a12, a1, 44 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a13, a1, 40 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a14, a1, 36 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a15, a1, 32 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a5, a1, 28 # 4-byte Folded Spill
...
; XTENSA-MUL-NEXT:    or a9, a11, a11
; XTENSA-MUL-NEXT:    s32i a8, a1, 24 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a7, a1, 20 # 4-byte Folded Spill
...
; XTENSA-MUL-NEXT:    l32i a9, a1, 28 # 4-byte Folded Reload
...
; XTENSA-MUL-NEXT:    l32i a9, a1, 20 # 4-byte Folded Reload
...
; XTENSA-MUL-NEXT:    l32i a9, a1, 12 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    add a5, a8, a9
; XTENSA-MUL-NEXT:    mull a2, a2, a10
; XTENSA-MUL-NEXT:    l32i a3, a1, 24 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a4, a1, 16 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a15, a1, 32 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a14, a1, 36 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a13, a1, 40 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a12, a1, 44 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    addi a8, a1, 48
; XTENSA-MUL-NEXT:    or a1, a8, a8
; XTENSA-MUL-NEXT:    ret
  %1 = mul i128 %a, -3840
...
; XTENSA-NEXT:    s32i a2, a1, 40 # 4-byte Folded Spill
; XTENSA-NEXT:    or a3, a12, a12
; XTENSA-NEXT:    or a5, a12, a12
; XTENSA-NEXT:    callx0 a8
; XTENSA-NEXT:    or a14, a3, a3
; XTENSA-NEXT:    l32r a8, .LCPI32_1
; XTENSA-NEXT:    s32i a15, a1, 24 # 4-byte Folded Spill
...
; XTENSA-NEXT:    or a3, a12, a12
; XTENSA-NEXT:    l32i a4, a1, 36 # 4-byte Folded Reload
; XTENSA-NEXT:    or a5, a12, a12
; XTENSA-NEXT:    callx0 a8
; XTENSA-NEXT:    add a9, a2, a13
...
; XTENSA-NEXT:    l32i a14, a1, 24 # 4-byte Folded Reload
...
; XTENSA-NEXT:    or a3, a2, a2
; XTENSA-NEXT:    l32i a4, a1, 40 # 4-byte Folded Reload
; XTENSA-NEXT:    callx0 a8
...
; XTENSA-NEXT:  .LBB32_8:
; XTENSA-NEXT:    l32i a10, a1, 32 # 4-byte Folded Reload
; XTENSA-NEXT:    l32i a11, a1, 28 # 4-byte Folded Reload
...
; XTENSA-MUL:       # %bb.0:
; XTENSA-MUL-NEXT:    addi a8, a1, -32
; XTENSA-MUL-NEXT:    or a1, a8, a8
; XTENSA-MUL-NEXT:    s32i a12, a1, 28 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a13, a1, 24 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a14, a1, 20 # 4-byte Folded Spill
; XTENSA-MUL-NEXT:    s32i a15, a1, 16 # 4-byte Folded Spill
...
; XTENSA-MUL-NEXT:    l32i a15, a1, 16 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a14, a1, 20 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a13, a1, 24 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    l32i a12, a1, 28 # 4-byte Folded Reload
; XTENSA-MUL-NEXT:    addi a8, a1, 32
; XTENSA-MUL-NEXT:    or a1, a8, a8
; XTENSA-MUL-NEXT:    ret
